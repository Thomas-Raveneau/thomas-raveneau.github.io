        ...
        <section className='container-fluid fill bg-category-dark p-category' id='CONTACTS' ref={sectionVisibilityRef}>
            ...
            <div className='row contacts-content-container'>
                ...
                <div className='col-lg-8 p-0 contacts-content-container-right'>
                    <p className='contacts-content-text'>I am Thomas Raveneau, a french studying at Epitech Paris. I am game programmer who wants to give pleasure to others through my games. If you liked my work, let's get in contact !</p>
                    <p className='contacts-content-text'>Since my childhood, I always had interest in video games, I remember playing video games on my dad's PS1 & PS2, games like Tomb Raider, Tekken and then Zelda on my own Gameboy and now playing great video games that I enjoy a lot on my PC. I love listening to music, watching movies, my favorites ones being Seven and Interstellar. Basically I love when stories are told to my ears and eyes, it's bringing me a lot of feelings.</p>
                    ...
                    <p className='contacts-content-text'>I love to talk about my passions and technological advances, not only in the video game industry, but in all kinds of technology.</p>
                </div>
            </div>
